...
3. If you receive an INVALID response, then either you’ve done something wrong or the original IPN should be treated as suspicious and investigated.
4. Update the password script to generate shadow compatible password using openssl. Prompt for the password, generate the password without showing it on the screen.
