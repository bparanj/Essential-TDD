...
CREATE TABLE "products" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "price" decimal(11,2) NOT NULL, "name" varchar(255) NOT NULL, "user_id" integer NOT NULL, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
...
CREATE TABLE "transactions" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "order_id" integer, "transaction_id" varchar(255), "action" varchar(255), "amount" integer, "success" boolean, "authorization" varchar(255), "message" varchar(255), "details" text, "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
