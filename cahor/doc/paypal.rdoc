...
1. Copy transaction_id from the Paypal Thank You page : 0UB45589MG4871049
2. Plug into : curl -d "txn_id=0UB45589MG4871049&invoice=1&payment_status=Completed" http://localhost:3020/sales

curl -d "txn_id= &invoice=1&payment_status=Completed" http://localhost:3020/sales

** Making a Request on Behalf of Third Part **
