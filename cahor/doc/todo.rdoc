...
3. Allow user to download the book when the payment is success. When sale status is 'fulfill'.
...
6. By default the urls aren’t very pretty, something like http://d1xdx2sah5udd0.cloudfront.net/stylesheets/foo.css. You can use CNAME config options to utilize something like http://assets.clickplan.net/stylesheets/foo.css.
