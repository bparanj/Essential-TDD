...
CREATE TABLE "products" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar(255) NOT NULL, "price" decimal(11,2) NOT NULL, "user_id" integer NOT NULL, "file" varchar(255), "thanks_page" varchar(255), "cancel_page" varchar(255), "sales_page" varchar(255), "download_page" varchar(255), "created_at" datetime NOT NULL, "updated_at" datetime NOT NULL);
