...
Sales to-do and Marketing to-do : Not required. Let people share PDF freely. Need some piracy to promote products in other formats.
...
Create kindle book video for Adobe connect : Market is not big enough. Don't do it. Make this as a blog post.


--------------------------------------------------------------------
To Do
--------------------------------------------------------------------
Buy chrome book and install ubuntu
Return system 76
